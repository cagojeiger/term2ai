...
### 마일스톤 1: 함수형 터미널 기반 (체크포인트 2 이후)
- **기능**: 순수 함수 기반 터미널 작업, Effect 시스템 I/O 처리
- **목표**: 부작용이 명시적으로 관리되는 기능적 터미널 래퍼
- **성공 기준**: 모든 I/O가 IOEffect로 캡슐화되고 순수 함수로 처리되는 셸 명령 실행
